...
//             newPoints = newPoints - currentPoints + futurePoints;
...
//   const [newScores, setNewScores] = useState({ home: "", away: "" });
//   const [participants, setParticipants] = useState([]);
//   const [games, setGames] = useState([]); // הוספת מצב לאחסון המשחקים
...
//         setGames(response.data); // שמירת המשחקים שהתקבלו
//       } catch (error) {
...
//     fetchGame();
//     fetchParticipants();
//     fetchAllGames(); // קריאה לפונקציה שמביאה את כל המשחקים
//   }, [id]);
...
//   //           const futurePoints =
//   //             newColor === "green" ? 3 : newColor === "yellow" ? 1 : 0;
...
//   //           ...participant,
//   //           points: newPoints,
//   //           totalPoints: calculateTotalPoints(participant), // סך הנקודות
//   //         };
//   //       });

//   //       updatedParticipants.sort((a, b) => b.totalPoints - a.totalPoints);
//   //       setParticipants(updatedParticipants);
...
//             // שמירת הניקוד המעודכן במסד הנתונים
//             await Promise.all(
//                 updatedParticipants.map((participant) =>
//                     axios.put(`http://localhost:5000/participants/${participant._id}`, {
//                         points: participant.totalPoints,
...
//         color,
//         points,
//         totalPoints: calculateTotalPoints(participant), // סך הנקודות בטבלת הלייב
//       };
//     })
